"""
Django settings for komatsu_telematics__46265 project.
...
ROOT_URLCONF = 'komatsu_telematics__46265.urls'
...
WSGI_APPLICATION = 'komatsu_telematics__46265.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "komatsu_telematics__46265 API",
    "DESCRIPTION": "API documentation for komatsu_telematics__46265 App",
    "VERSION": "v1",
}
